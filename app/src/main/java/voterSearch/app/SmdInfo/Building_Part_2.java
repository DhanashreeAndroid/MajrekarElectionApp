...
public class Building_Part_2 extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		{
			txt4.setText("Building Wise Search");
		}
		else
		{
			txt4.setText("Building Wise Search of Part No : " + partNo);
		}
		...
		lv.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> parent, View view, int position,
				...
				Intent i = new Intent(Building_Part_2.this, Building_Part_3.class);
		...
		btnSearch.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {
				...
				Building_Part_2.this.adapter.getFilter().filter(edtSearch.getText().toString().trim());
	...
	public void GenerateList()
	{
		if(partNo.equals("Blank"))
		{
			cursor = mDbAdapter.GetAddress_Blank();
		...
		{
			cursor = mDbAdapter.GetAddress_PartNoWise(partNo,  getIntent().getExtras().getString("wardNo"));
	...
	private class LoadData extends AsyncTask<String, Void, String> 
	 {
	     ...
	     {
	     	 progressDialog = new ProgressDialog(Building_Part_2.this);
		...
		protected String doInBackground(String... params) 
	     ...
	     protected void onPostExecute(String result) 
	     {
			 ...
			 {
				 txtBuildingCount.setText("Total Buildings - " + String.valueOf(adapter.getCount()) + " In Part - " + partNo);
			 }
