...
public class Alpha_VoterList_first_Filter extends Activity{
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		txt4.setText("Alphabetical Voter Search Filter");
		...
		btnPart.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				Intent i = new Intent(Alpha_VoterList_first_Filter.this, Alpha_VoterList_Types.class);
				startActivity(i);
		...
		btnFullVidhan.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				Intent i = new Intent(Alpha_VoterList_first_Filter.this, Alpha_VoterList_Display.class);
				startActivity(i);
